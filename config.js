...
global.devs = '923011080145';
global.website = 'https://github.com/prabathLK/PRABATH-MD' //wa.me/+923011080145
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || '𝑆𝛥𝐿𝛭𝛥𝛮-MD',
  dl_limit: process.env.DL_SIZE || '400',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '923011080145',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/ad25b2227fa2a1a01b707.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY 𝑆𝛥𝐿𝛭𝛥𝛮-MD* 🎊',
  ownername:process.env.OWNER_NAME || '𝑆𝛥𝐿𝛭𝛥𝛮',
